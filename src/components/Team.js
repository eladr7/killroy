        ...
        <section id="team-footer-background">
            ...
            <div className="live">
                <div className="mobilecol">
                    ...
                    <div className="live-img-1-2"> <img src="./image/scrt2.jpeg" alt="" /> </div>
                ...
                <div className="live-img-3"> <img src="./image/designer.jpeg" alt="" />
                    <div className="live-img-1-content">
                        <h3>Designer<span><img src="./image/Vector (3).png" alt="" /> <img src="./image/Vector (4).png" alt="" /></span></h3>
                    </div>
                </div>
                <div className="live-img-4"> <img src="./image/developer.jpeg" alt="" />
                    <div className="live-img-1-content">
                        <h3>Developer<span><img src="./image/Vector (3).png" alt="" /> <img src="./image/Vector (4).png" alt="" /></span></h3>
                    </div>
                </div>
            </div>
        </section>
